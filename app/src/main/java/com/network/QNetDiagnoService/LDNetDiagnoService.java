...
import com.network.QNetDiagnoService.LDNetPing.LDNetPingListener;
import com.network.QNetDiagnoService.LDNetSocket.LDNetSocketListener;
...
public class LDNetDiagnoService extends
  ...
  private LDNetPing _netPinging; // 监控ping命令的执行时间
  private LDNetDownload _netDownloader; // 监控ping命令的执行时间
  private LDNetUp _netUper; // 监控ping命令的执行时间
  private LDNetDns _netDnser; // 监控ping命令的执行时间 _netUper; // 监控ping命令的执行时间
